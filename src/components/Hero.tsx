        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          ...
          <div className="flex-1 max-w-md">
            <div className="relative">
              ...
              <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-black/80 via-black/40 to-transparent rounded-b-xl" /> {/* Reduced height from h-32 to h-16 */}
              <div className="absolute -left-8 -right-8 top-1/2 h-24 bg-gradient-to-r from-purple-500/10 via-blue-500/20 to-purple-500/10 blur-2xl transform -skew-y-3" /> {/* Reduced height from h-32 to h-24 */}
              ...
              />
              <div className="absolute -bottom-2 -left-4 -right-4 h-4 bg-black/80 blur-xl rounded-full transform rotate-1" /> {/* Reduced height and blur */}
              <div className="absolute -bottom-1 -left-8 -right-8 h-1 bg-purple-500/30 blur-sm" />
              <div className="absolute -bottom-2 -left-8 -right-8 h-1 bg-blue-500/20 blur-sm" />
            </div>
          </div>
        </div>
      </div>
